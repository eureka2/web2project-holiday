...
/**
 * Filter that only accepts holidays in Moselle (France).
 *
 * @category   Date
 * @package    Date_Holidays
 * @subpackage Filter
...
class Date_Holidays_Filter_France_Moselle extends Date_Holidays_Filter_France_Official
{
    /**
     * Constructor.
     */
     ...
     */
    function Date_Holidays_Filter_France_Moselle()
    {
        $this->__construct();
    }
}
