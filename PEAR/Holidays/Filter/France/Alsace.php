...
/**
 * Filter that only accepts holidays in Alsace (France).
 *
 * @category   Date
 * @package    Date_Holidays
 * @subpackage Filter
...
class Date_Holidays_Filter_France_Alsace extends Date_Holidays_Filter_France_Official
{
    /**
     * Constructor.
     */
     ...
     */
    function Date_Holidays_Filter_France_Alsace()
    {
        $this->__construct();
    }
}
