<?php
/**
 * Filter for Guyana (France) holidays.
 *
 * PHP Version 4
 *
...
/**
 * Filter that only accepts holidays in Guyana (France).
 *
 * @category   Date
 * @package    Date_Holidays
 * @subpackage Filter
...
class Date_Holidays_Filter_France_Guyana extends Date_Holidays_Filter_France_Official
{
    /**
     * Constructor.
     */
     ...
     */
    function Date_Holidays_Filter_France_Guyana()
    {
        $this->__construct();
    }
}
